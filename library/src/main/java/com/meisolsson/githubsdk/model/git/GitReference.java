...
public abstract class GitReference implements Parcelable {
    ...
    public static JsonAdapter<GitReference> jsonAdapter(Moshi moshi) {
        return new AutoValue_GitReference.MoshiJsonAdapter(moshi);
    }

    public static Builder builder() {
        return new AutoValue_GitReference.Builder();
    }
    ...
    public abstract static class Builder {
        ...
        public abstract Builder object(GitReferenceEntry object);
