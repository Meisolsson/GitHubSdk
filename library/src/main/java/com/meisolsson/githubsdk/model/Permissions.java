...
public abstract class Permissions implements Parcelable {
    ...
    public static JsonAdapter<Permissions> jsonAdapter(Moshi moshi) {
        return new AutoValue_Permissions.MoshiJsonAdapter(moshi);
    }

    public static Builder builder() {
        return new AutoValue_Permissions.Builder();
    }
    ...
    public abstract static class Builder {
        ...
        public abstract Builder push(Boolean push);

        public abstract Builder pull(Boolean pull);
