...
public abstract class CreateGitBlob implements Parcelable {
    ...
    public static JsonAdapter<CreateGitBlob> jsonAdapter(Moshi moshi) {
        return new AutoValue_CreateGitBlob.MoshiJsonAdapter(moshi);
    }

    public static Builder builder() {
        return new AutoValue_CreateGitBlob.Builder();
    }
