...
@AutoValue
public abstract class EditMilestone implements Parcelable {
    ...
    public static JsonAdapter<EditMilestone> jsonAdapter(Moshi moshi) {
        return new AutoValue_EditMilestone.MoshiJsonAdapter(moshi);
    }

    public static Builder builder() {
        return new AutoValue_EditMilestone.Builder();
    }
    ...
    public abstract static class Builder {
        ...
        public abstract EditMilestone build();
    }
}
