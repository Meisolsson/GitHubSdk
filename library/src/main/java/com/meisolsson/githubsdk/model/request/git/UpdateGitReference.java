...
public abstract class UpdateGitReference implements Parcelable {
    ...
    public static JsonAdapter<UpdateGitReference> jsonAdapter(Moshi moshi) {
        return new AutoValue_UpdateGitReference.MoshiJsonAdapter(moshi);
    }

    public static Builder builder() {
        return new AutoValue_UpdateGitReference.Builder();
    }
